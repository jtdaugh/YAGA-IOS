...
#define kBarHeight 50.0
#define kStatusBarHeight 0.0

@implementation YAStandardFlexibleHeightBar

+ (YAStandardFlexibleHeightBar *)emptyStandardFlexibleBar {
    
    YAStandardFlexibleHeightBar *bar = [[YAStandardFlexibleHeightBar alloc] initWithFrame:CGRectMake(0.0, 0.0, VIEW_WIDTH, kBarHeight)];
