...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(LEFT_MARGIN, Y_MARGIN, frame.size.width - LEFT_MARGIN - RIGHT_MARGIN - ACCESSORY_SIZE - 5, NAME_HEIGHT)];
        [self.nameLabel setFont:[UIFont fontWithName:BIG_FONT size:30]];
        ...
        self.membersLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.nameLabel.frame.origin.x,
                                                                     ...
                                                                     MEMBERS_HEIGHT)];
        self.membersLabel.numberOfLines = 2;
